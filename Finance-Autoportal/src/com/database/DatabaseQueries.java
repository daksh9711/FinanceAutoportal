...
public class DatabaseQueries  {
	 void Financedatabasequery() {
			...
			try{  
				...
				"jdbc:mysql://192.168.1.250:3306/ap_finance","qa_daksh","zh7QI0uUsiAXyIw4");  
			...
			//	String string1="UPDATE `finance_customer` SET `otp_verified` = '1' WHERE id=";
				...
				stmt.execute("UPDATE `finance_customer` SET `otp_verified` = '1' WHERE id=5923");  
				ResultSet rs=stmt.executeQuery("select * from finance_customer WHERE id=5923");
